...
public class Azul implements Time {
	Scanner tt = new Scanner(System.in);
	@Override
	public Personagem Personagem1() {
		System.out.println("Vamos Escolher os Personagens da equipe Azul\nPrimeiro Vamos escolher a classe");
		while(true) {
			System.out.println("[1] Ranger\n[2] Sup\n[3] Mago\n[4] Tank");
			int classe = tt.nextInt();
			switch (classe) {
			case 1:
				System.out.println("A classe Ranger e conhecida por tem alto dano mas pouca vida. Vamos ver seus Campeoes");
				...
				case 1:
					...
					Funcoes.espacamento();
					System.out.println("Varus adicionado a equipe Azul");
					return p1;
				case 2:
					Personagem p2 =  new kindred("Kindred", 1300, 450, 70, 30, false,false,true);
					Funcoes.espacamento();
					System.out.println("Kindred adicionado a equipe Azul");
					return p2;
				case 3:
					Personagem p3 =  new Ashe("Ashe", 900, 500, 110, 19, false,false,true);
					Funcoes.espacamento();
					System.out.println("Ashe adicionado a equipe Azul");
					return p3;
			...
			case 2:
				System.out.println("A classe Sup e conhecida por ter pouco dano mas ser uma otima ajuda. Vamos ver seus Campeoes");
				...
				case 1:
					...
					Funcoes.espacamento();
					System.out.println("Soraka adicionado a equipe Azul");
					return p1;
				case 2:
					Personagem p2 =  new Braum("Braum", 2000, 600, 30, 50, false,false,true);
					Funcoes.espacamento();
					System.out.println("Braum adicionado a equipe Azul");
					return p2;
				case 3:
					Personagem p3 =  new Lulu("Lulu", 800, 1200, 35, 30, false,false,true);
					Funcoes.espacamento();
					System.out.println("Lulu adicionado a equipe Azul");
					return p3;
			...
			case 3:
				System.out.println("A classe Mago e conhecida por ter alto dano mas pouca vida. Vamos ver seus Campeoes");
				...
				case 1:
					...
					Funcoes.espacamento();
					System.out.println("Vladmir adicionado a equipe Azul");
					return p1;
				case 2:
					Personagem p2 =  new Ahri("Ahri", 1000, 1200, 100, 19, false,false,true);
					Funcoes.espacamento();
					System.out.println("Ahri adicionado a equipe Azul");
					return p2;
				case 3:
					Personagem p3 =  new Veigar("Veigar", 1000, 100, 200, 19, false,false,true);
					Funcoes.espacamento();
					System.out.println("Veigar adicionado a equipe Azul");
					return p3;
			...
			case 4:
				System.out.println("A classe Tank e conhecida por aguenta muito dano e ajudar os aliados.Vamos ver seus Campeoes");
				...
				case 1:
					...
					Funcoes.espacamento();
					System.out.println("Sion adicionado a equipe Azul");
					return p1;
				case 2:
					Personagem p2 =  new JarvanIV("Jarvan IV", 1500, 700, 100, 40, false,false,true);
					Funcoes.espacamento();
					System.out.println("Jarvan IV adicionado a equipe Azul");
					return p2;
				case 3:
					Personagem p3 =  new Mordekaise("Mordekaiser", 2000, 800, 70, 30, false,false,true);
					Funcoes.espacamento();
					System.out.println("Mordekaiser adicionado a equipe Azul");
					return p3;
