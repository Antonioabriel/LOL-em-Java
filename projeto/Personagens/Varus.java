...
public class Varus extends Atirador{
	


	public Varus(String nome, int vida, int mana, int dano, int armadura,boolean atacou,boolean cura,boolean viva) {
	...
	public void habilidade1(Personagem p) {
		if(!p.isViva()) {
			...
			this.setDano(this.getDano() + (p.getDano()/3));
			if(p.getVida() <=0) {
				p.setViva(false);
				p.setVida(0);
	...
	public void habilidade3(Personagem p) {
		if(!p.isViva()) {
			...
			p.setVida(p.getVida() -(this.getDano() + 100));
	...
	public String nomehabilidade1() {
		...
		return "[1] Flecha Perfurante";
	}

	@Override
	public String nomehabilidade2() {
		// TODO Auto-generated method stub
		return "[2] Chuva de Flechas";
	}

	@Override
	public String nomehabilidade3() {
		// TODO Auto-generated method stub
		return "[3] Corrente da Corrupcao";
	}
