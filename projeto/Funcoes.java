...
public class Funcoes {
	...
	public static void vez(Personagem vez, String time) {
        ...
        System.out.println("Vez de " + vez.getNome() + "\n" + vez.nomehabilidade1() + "\n" + vez.nomehabilidade2()
                + "\n" + vez.nomehabilidade3() + "\n");
	}
	...
	public static void statusAzul(Personagem Azul1,Personagem Azul2,Personagem Azul3) {
		 ...
		 System.out.println("Nome:" + Azul1.getNome() + "     Nome: " + Azul2.getNome()+ "     Nome: " + Azul3.getNome());
		 System.out.println("Vida: " + Azul1.getVida() + "     Vida: " + Azul2.getVida()+ "     Vida: " + Azul3.getVida());
		 System.out.println("Mana: " + Azul1.getMana() + "     Mana: " + Azul2.getMana()+ "     Mana: " + Azul3.getMana());
		 System.out.println("Armadura: " + Azul1.getArmadura() + "   Armadura: " + Azul2.getArmadura()+ "   Armadura: " + Azul3.getArmadura()+ "\n\n");
		 
		
	}
	 public static void statusVermelho(Personagem Vermelho1,Personagem Vermelho2,Personagem Vermelho3) {
		
		 System.out.println("Nome:" + Vermelho1.getNome() + "     Nome: " + Vermelho2.getNome()+ "     Nome: " + Vermelho3.getNome());
		 System.out.println("Vida: " + Vermelho1.getVida() + "     Vida: " + Vermelho2.getVida()+ "     Vida: " + Vermelho3.getVida() );
		 System.out.println("Mana: " + Vermelho1.getMana() + "     Mana: " + Vermelho2.getMana()+ "     Mana: " + Vermelho3.getMana());
		 System.out.println("Armadura: " + Vermelho1.getArmadura() + "   Armadura: " + Vermelho2.getArmadura()+ "   Armadura: " + Vermelho3.getArmadura() + "\n\n");
